...
def hex_str_to_rev_bytes(s):
    return hex_str_to_bytes(s)[::-1]

def hex_str_rev_hex_str(s):
    return bytes_to_hex_str(hex_str_to_rev_bytes(s))
...
def assert_not(thing1):
    if thing1 != False:
        raise AssertionError("%s != False"%(str(thing1)))
